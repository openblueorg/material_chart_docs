// stackedbar_widgets.dart
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import '../constants.dart';
import 'models.dart';

/// Reusable UI components for stacked bar chart documentation
class StackedBarChartWidgets {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Interactive stacked bar charts for Flutter',
                      style: TextStyle(
                        fontSize: 16,
          ...
          const Text(
            'Create powerful stacked bar charts with smooth animations, interactive features, and comprehensive customization options. '
            'Perfect for comparing part-to-whole relationships, analyzing category breakdowns, and building analytical dashboards.',
            style: TextStyle(
              fontSize: 14,
              color: AppColors.textSecondary,
              height: 1.5,
  ...
  static Widget buildExampleSelector(
    List<StackedBarChartExample> examples,
    int selectedIndex,
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: example.data.isNotEmpty
                        ? example.data[0].segments.take(3).map((segment) => 
                            Expanded(
                              child: Container(
                                decoration: BoxDecoration(
                                  color: segment.color,
  ...
  static Widget buildColorSetButton(
    StackedBarColorSetOption colorSet,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            // Color preview as stacked segments
            Container(
              width: 20,
              height: 12,
              decoration: BoxDecoration(
              ...
              child: Row(
                children: colorSet.colors.take(4).map((color) => 
                  Expanded(
                    child: Container(
                      decoration: BoxDecoration(
                        color: color,
  ...
  static Widget buildAnimationCurveDropdown(
    List<StackedBarCurveOption> curves,
    Curve selectedCurve,
  ...
  // Property Row Widget
  static Widget buildPropertyRow(StackedBarPropertyInfo property, bool isLast) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        border: isLast
